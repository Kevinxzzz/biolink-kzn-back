...
exports.consolidateInfluencerClicks = exports.consolidateClicks = void 0;
...
const consolidateInfluencerClicks = async () => {
    let cursor = "0";
    do {
        // MATCH influencer_clicks:*:* - as chaves são influencer_clicks:enterpriseId:influencerId
        const [nextCursor, keys] = await redis_1.redis.scan(cursor, "MATCH", "influencer_clicks:*:*", "COUNT", "100");
        cursor = nextCursor;
        for (const key of keys) {
            try {
                const parts = key.split(":");
...
exports.consolidateInfluencerClicks = consolidateInfluencerClicks;
