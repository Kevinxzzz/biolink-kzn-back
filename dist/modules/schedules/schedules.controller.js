...
const schedulesService = __importStar(require("./schedules.service"));
const create = async (req, res, next) => {
    try {
        const parsedData = schedules_zod_1.createScheduleZod.parse(req.body);
...
const update = async (req, res, next) => {
    try {
        const parsedData = schedules_zod_1.updateScheduleZod.parse(req.body);
        const enterpriseId = req.user.enterpriseId;
        const id = req.params.id;
